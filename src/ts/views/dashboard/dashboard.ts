...
import { getData, getFilterEntityData } from "../../endpoints.js"
...
export class Dashboard implements NDashbd.IRender {
  ...
  private async renderlastNotes(): Promise<void> {
    async function getNotes() {
      //let url: string = 'https://backend3.netliinks.com:443/rest/entities/Note?fetchPlan=full&&limit=5&&offset=0'
      ...
      return filterNotes*/
        ...
        return await getFilterEntityData("Note", raw)
      }
